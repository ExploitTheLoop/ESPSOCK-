...
ssize_t process_vm_writev(pid_t pid,   struct iovec* local_iov, unsigned long local_iov_count, struct iovec* remote_iov, unsigned long remote_iov_count, unsigned long flags) {
 return syscall(process_vm_writev_syscall, pid, local_iov, local_iov_count, remote_iov, remote_iov_count, flags);
}
